...
namespace password
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int titlePositionWidth = 50;
            int titlePositionHeight = 1;
            int legendPositionWidth = 3;
            int legendPositionHeight = 5;
            int heroHitbarWidth = 3;
            int heroHitbarHeight = 9;
            int heroAbilitiesbarWidth = 50;
            int heroAbilitiesbarHeight = 40;
            int enemyHitbarWidth = 100;
            int enemyHitbarHeight = 9;
            int playerActionsbarWidth = 3;
            int playerActionsbarHeight = 40;
            int battleEventsbarWidth = 0;
            int battleEventsbarHeight = 18;
            int andGamebarWith = 50;
            int andGamebarHeight = 20;
            bool gameIsContinues = true;

            Console.SetWindowSize(windowWidth, windowHeight);
            // title of the game
            cursorPositionWidth = titlePositionWidth;
            cursorPositionHeight = titlePositionHeight;
            ...
            Console.ReadKey();
            // legend of the game
            cursorPositionWidth = legendPositionWidth;
            cursorPositionHeight = legendPositionHeight;
            ...
            while (gameIsContinues)
            {
                ...
                Console.WriteLine("The sprawling cranberry of Middle-Earth ");
                // hero's hitbar
                cursorPositionWidth = heroHitbarWidth;
                cursorPositionHeight = heroHitbarHeight;
                Console.SetCursorPosition(cursorPositionWidth, cursorPositionHeight++);
                ...
                //hero's abilities
                cursorPositionWidth = heroAbilitiesbarWidth;
                cursorPositionHeight = heroAbilitiesbarHeight;
                Console.SetCursorPosition(cursorPositionWidth, cursorPositionHeight++);
                ...
                Console.SetCursorPosition(cursorPositionWidth, cursorPositionHeight++);
                Console.WriteLine("4 - Зажигательный танец (нужно накатить: при активной способности №2 лечит {0} здоровья)", heroDanseHeal);
                //enemy hitbar
                cursorPositionWidth = enemyHitbarWidth;
                cursorPositionHeight = enemyHitbarHeight;
                Console.SetCursorPosition(cursorPositionWidth, cursorPositionHeight++);
                ...
                //player actions
                cursorPositionWidth = playerActionsbarWidth;
                cursorPositionHeight = playerActionsbarHeight;
                Console.SetCursorPosition(cursorPositionWidth, cursorPositionHeight);
                ...
                //battle events
                cursorPositionWidth = battleEventsbarWidth;
                cursorPositionHeight = battleEventsbarHeight ;
            ...
            {                
                ...
                Console.Clear();
                cursorPositionWidth = andGamebarWith;
                cursorPositionHeight = andGamebarHeight;
                Console.SetCursorPosition(cursorPositionWidth, cursorPositionHeight++);
